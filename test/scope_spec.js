...
describe("Scope", function() {
  ...
  describe("digest", function(){
    ...
    it("executes $evalAsync'ed function in the same cycle", function() {
      scope.aValue = [1,2,3];
    ...
    it("executes $evalAsnc'ed functions added by watch functions", function() {
      scope.aValue = [1,2,3];
      scope.asyncEvaluated = false;
    ...
    it("has a $$phase field whose value is the current digest phase", function() {
      ...
      scope.phaseInApplyFunciton = undefined;

      scope.$watch(
        function(scope) {
          scope.phaseInWatchFunciton = scope.$$phase;
          return scope.aValue;
      ...
      scope.$apply(function(scope) {
        scope.phaseInApplyFunciton = scope.$$phase;
      });

      expect(scope.phaseInWatchFunciton).toBe('$digest');
      expect(scope.phaseInListenerFunction).toBe('$digest');
      expect(scope.phaseInApplyFunciton).toBe('$apply');
  ...
  describe('$watchGroup', function() {
    ...
    it("it watches as an array and calls listener with arrays", function() {
    ...
    it("does not call the zero-watch listener when degregistered first", function() {
      var counter = 0;
  ...
  describe("$watchCollection", function() {
    ...
    it("notices when an attribute is changed in an object", function() {
      ...
      scope.$watchCollection(
        function(socpe) { return scope.obj; },
        function(newValue, oldValue, scope) {
          scope.counter++;
        }
      );
  ...
  describe("Events", function() {
    ...
    /*
      *
       This test runs all the tests against each parameter passed to LoDash's forEach loop
      *
    */
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it("passes an event object with a name to listeners on "+method, function() {
        ...
        // calls.mostRecent() is a Jasmine spy function and contains info on last spy call.
        // args attribute contains an array of arguments passed to the function.
      });
      ...
      it("can be degregistered "+method, function() {
        var listener = jasmine.createSpy();
